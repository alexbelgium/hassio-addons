## &#9888; Open Issue : [🐛 [FireflyIII] Unable to create a directory when using mariaDB at /var/www/html/storage/ha_upload (opened 2022-10-31)](https://github.com/alexbelgium/hassio-addons/issues/534) by [@diamant-x](https://github.com/diamant-x)
