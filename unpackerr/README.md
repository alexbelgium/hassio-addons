...
No webui. Options can be configured through two ways :
...
- Config.yaml
  Everything is configured using the config.yaml file found in /config/addons_config/unpackerr/config.yaml

The list of environment variables can be found here : https://github.com/davidnewhall/unpackerr
