...
- Supports extra environment variables via the `env_vars` option, see https://github.com/alexbelgium/hassio-addons/wiki/Add-Environment-variables-to-your-Addon-2
