...
1. Filebrowser (10325x)
2. Portainer (3405x)
3. Myelectricaldata (3351x)
...
&#10003; ![image](https://api.iconify.design/mdi/file-search.svg) [Filebrowser (10325x)](filebrowser/) : filebrowser provides a file managing interface within a specified directory and it can be used to upload, delete, preview, rename and edit your files
...
&#10003; ![image](https://api.iconify.design/mdi/docker.svg) [Portainer (3405x)](portainer/) : Manage your Docker environment with ease
...
&#10003;  [Portainer (3405x) Agent](portainer_agent/) : An agent used to manage all the resources in a Swarm cluster
