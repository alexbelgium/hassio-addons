...
&#10003;  [Firefly iii](fireflyiii/) : A free and open source personal finance manager (35 users)
...
&#10003;  [Firefly iii Data Importer](fireflyiii_data_importer/) : Data importer for Firefly III (separate addon) (15 users)
...
&#10003;  [Firefly iii FinTS Importer](fireflyiii_fints_importer/) : Import financial transactions from your FinTS enabled bank into Firefly III (6 users)
...
&#10003;  [Jackett NAS](jackett/) : translates queries from apps (Sonarr, SickRage, CouchPotato, Mylar, etc) into tracker-site-specific http queries, parses the html response, then sends results back to the requesting software ( users)
...
&#10003; ![image](https://api.iconify.design/mdi/billiards-rack.svg) [Jellyfin NAS](jellyfin/) : A Free Software Media System that puts you in control of managing and streaming your media. ( users)
...
&#10003; ![image](https://api.iconify.design/mdi/owl.svg) [Joal](joal/) : An open source command line RatioMaster with WebUI ( users)
...
&#10003;  [Joplin Server](joplin/) : Self-hosted open source note-taking application ( users)
...
&#10003;  [Lidarr NAS](lidarr/) : Music collection manager for Usenet and BitTorrent users ( users)
...
&#10003; ![image](https://api.iconify.design/mdi/silverware-fork-knife.svg) [Mealie](mealie/) : Mealie is a self hosted recipe manager and meal planner built in Vue ( users)
...
&#10003;  [MyElectricalData](enedisgateway2mqtt/) : use Enedis Gateway API to send data in your MQTT Broker (latest channel) ( users)
...
&#10003;  [MyElectricalData Dev](enedisgateway2mqtt_dev/) : use Enedis Gateway API to send data in your MQTT Broker (dev channel) ( users)
...
&#10003;  [Papermerge](papermerge/) : Open source document management system (DMS) (11 users)
...
&#10003; ![image](https://api.iconify.design/mdi/camera.svg) [Photoprism](photoprism/) : A server-based application for browsing, organizing and sharing your personal photo collection (95 users)
...
&#10003;  [Piwigo](piwigo/) : Piwigo is a photo gallery software for the web (16 users)
...
&#10003;  [Plex NAS](plex/) : Plex organizes video, music and photos from personal media libraries and streams them to smart TVs, streaming boxes and mobile devices. (151 users)
...
&#10003; ![image](https://api.iconify.design/mdi/transmission-tower.svg) [Transmission Openvpn](transmission_openvpn/) : Docker container running Transmission torrent client with WebUI over an OpenVPN tunnel ( users)
...
&#10003;  [Ubooquity](ubooquity/) : Free, lightweight, and easy-to-use home server for your comics and ebooks ( users)
...
&#10003;  [Unpackerr](unpackerr/) : Unpacks RARd files for Sonarr, Lidarr and Radarr ( users)
...
&#10003;  [Vaultwarden (Bitwarden)](bitwarden/) : Open source password management solution ( users)
...
&#10003; ![image](https://api.iconify.design/mdi/monitor.svg) [Webtop Alpine KDE](webtop_kde/) : Full linux desktop environment accessible via any modern web browser ( users)
...
&#10003;  [Webtrees](webtrees/) : web's leading on-line collaborative genealogy application (21 users)
...
&#10003;  [Wger](wger/) : manage your personal workouts, weight and diet plans (18 users)
...
&#10003; ![image](https://api.iconify.design/mdi/magnify.svg) [Whoogle Search](whoogle/) : Self-hosted, ad-free, privacy-respecting metasearch engine (27 users)
...
&#10003;  [Zoneminder](zoneminder/) : A full-featured, open source, state-of-the-art video surveillance software system (43 users)
