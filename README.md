...
&#10003;  [Arpspoof](arpspoof/) : block internet connection for local network devices ( users)
...
&#10003;  [Baikal](baikal/) : Baïkal is a Calendar+Contacts server ( users)
...
&#10003;  [Bazarr NAS](bazarr/) : Companion application to Sonarr and Radarr to download subtitles ( users)
...
&#10003;  [Booksonic-air](booksonic_air/) : platform for accessing the audibooks you own wherever you are ( users)
...
&#10003;  [Browserless Chrome](browserless_chrome/) : Chrome as a service container ( users)
...
&#10003; ![image](https://api.iconify.design/mdi/book-multiple.svg) [Calibre](calibre/) : e-book manager ( users)
...
&#10003; ![image](https://api.iconify.design/mdi/library.svg) [Calibre-web](calibre_web/) : browsing, reading and downloading eBooks using an existing Calibre database ( users)
...
&#10003; ![image](https://api.iconify.design/mdi/file-search.svg) [Cloudcommander](cloudcommander/) : Cloud Commander a file manager for the web with console and editor ( users)
...
&#10003;  [Code-server (VScode)](code-server/) : Code-server is VS Code running on a remote server, accessible through the browser. ( users)
...
&#10003;  [Elasticsearch server](elasticsearch/) : Free and Open, Distributed, RESTful Search Engine ( users)
...
&#10003; ![image](https://api.iconify.design/mdi/emby.svg) [Emby NAS](emby/) : A Free Software Media System that puts you in control of managing and streaming your media. ( users)
...
&#10003;  [Epic Games Free](epicgamesfree/) : Automatically login and redeem promotional free games from Epic Games Store ( users)
...
&#10003; ![image](https://api.iconify.design/mdi/file-search.svg) [Filebrowser](filebrowser/) : filebrowser provides a file managing interface within a specified directory and it can be used to upload, delete, preview, rename and edit your files ( users)
...
&#10003;  [Firefly iii](fireflyiii/) : A free and open source personal finance manager ( users)
...
&#10003;  [Firefly iii Data Importer](fireflyiii_data_importer/) : Data importer for Firefly III (separate addon) ( users)
...
&#10003;  [Firefly iii FinTS Importer](fireflyiii_fints_importer/) : Import financial transactions from your FinTS enabled bank into Firefly III ( users)
...
&#10003;  [FlareSolverr](flaresolverr/) : Proxy server to bypass Cloudflare protection ( users)
...
&#10003;  [Flexget](flexget/) : FlexGet is a multipurpose automation tool for all of your media ( users)
...
&#10003;  [Gazpar2mqtt](gazpar2mqtt/) : fetch GRDF data and publish data to a mqtt broker ( users)
...
&#10003;  [Gitea](gitea/) : Gitea for Home Assistant ( users)
...
&#10003;  [Grav web server](grav/) : Fast, Simple, and Flexible, file-based Web-platform ( users)
...
&#10003; ![image](https://api.iconify.design/mdi/lan.svg) [Guacamole Client](guacamole/) : Clientless remote desktop gateway ( users)
...
&#10003;  [Inadyn](inadyn/) : Inadyn is a small and simple Dynamic DNS, DDNS, client with HTTPS support. A large number of dynamic dns providers are supported (https://github.com/troglobit/inadyn#supported-providers). For those that are not, you can use a custom provider as per this project's documentation (https://github.com/nalipaz/hassio-addons/blob/master/README.md) ( users)
...
&#10003;  [Jackett NAS](jackett/) : translates queries from apps (Sonarr, SickRage, CouchPotato, Mylar, etc) into tracker-site-specific http queries, parses the html response, then sends results back to the requesting software (40 users)
...
&#10003; ![image](https://api.iconify.design/mdi/billiards-rack.svg) [Jellyfin NAS](jellyfin/) : A Free Software Media System that puts you in control of managing and streaming your media. (51 users)
...
&#10003; ![image](https://api.iconify.design/mdi/owl.svg) [Joal](joal/) : An open source command line RatioMaster with WebUI (5 users)
...
&#10003;  [Lidarr NAS](lidarr/) : Music collection manager for Usenet and BitTorrent users (5 users)
...
&#10003; ![image](https://api.iconify.design/mdi/silverware-fork-knife.svg) [Mealie](mealie/) : Mealie is a self hosted recipe manager and meal planner built in Vue (7 users)
...
&#10003;  [MyElectricalData](enedisgateway2mqtt/) : use Enedis Gateway API to send data in your MQTT Broker (latest channel) (79 users)
...
&#10003;  [MyElectricalData Dev](enedisgateway2mqtt_dev/) : use Enedis Gateway API to send data in your MQTT Broker (dev channel) (8 users)
...
&#10003;  [Mylar3](mylar3/) : Automated comic book downloader for use with NZB and torrents ( users)
...
&#10003; ![image](https://api.iconify.design/mdi/cloud.svg) [Nextcloud](nextcloud/) : Nextcloud for Home Assistant ( users)
...
&#10003; ![image](https://api.iconify.design/mdi/arrow-down-bold-circle-outline.svg) [Nzbget](nzbget/) : usenet downloader ( users)
...
&#10003;  [Omada](omada/) : TP-Link Omada Controller ( users)
...
&#10003;  [Omada v3.2](omada_v3/) : TP-Link Omada Controller ( users)
...
&#10003;  [Ombi](ombi/) : Self-hosted Plex Request and user management system ( users)
...
&#10003;  [Organizr](organizr/) : An HTPC/Homelab services organizer that is written in PHP ( users)
...
&#10003;  [Overseerr](overseerr/) : Request management and media discovery tool built to work with your existing Plex ecosystem ( users)
...
&#10003;  [Paperless NGX](paperless_ngx/) : scan, index and archive all your physical documents ( users)
...
&#10003;  [Papermerge](papermerge/) : Open source document management system (DMS) ( users)
...
&#10003; ![image](https://api.iconify.design/mdi/camera.svg) [Photoprism](photoprism/) : A server-based application for browsing, organizing and sharing your personal photo collection ( users)
...
&#10003;  [Piwigo](piwigo/) : Piwigo is a photo gallery software for the web ( users)
...
&#10003;  [Plex NAS](plex/) : Plex organizes video, music and photos from personal media libraries and streams them to smart TVs, streaming boxes and mobile devices. ( users)
...
&#10003;  [Plex meta manager](plex_meta_manager/) : Python script to update metadata information for movies, shows, and collections as well as automatically build collections ( users)
...
&#10003; ![image](https://api.iconify.design/mdi/docker.svg) [Portainer](portainer/) : Manage your Docker environment with ease ( users)
...
&#10003;  [Prowlarr NAS](prowlarr/) : Torrent Trackers and Usenet Indexers offering complete management ofSonarr, Radarr, Lidarr, and Readarr indexers with no per app setup required ( users)
...
&#10003; ![image](https://api.iconify.design/mdi/progress-download.svg) [Qbittorrent](qbittorrent/) : qBittorrent is a bittorrent client ( users)
...
&#10003;  [Radarr NAS](radarr/) : A fork of Sonarr to work with movies like Couchpotato ( users)
...
&#10003;  [Readarr NAS](readarr/) : Book Manager and Automation ( users)
...
&#10003;  [Repository Updater](addons_updater/) : Automatic addons update by aligning version tag with upstream releases ( users)
...
&#10003;  [Requestrr](requestrr/) : Chatbot used to simplify using services like Sonarr/Radarr/Ombi via the use of chat ( users)
...
&#10003; ![image](https://api.iconify.design/mdi/cloud-sync-outline.svg) [ResilioSync](resiliosync/) : Self-hosted file share and collaboration platform on the web ( users)
...
&#10003; ![image](https://api.iconify.design/mdi/glasses.svg) [Scrutiny](scrutiny/) : Scrutiny WebUI for smartd S.M.A.R.T monitoring ( users)
...
&#10003; ![image](https://api.iconify.design/mdi/glasses.svg) [Scrutiny (Full Access)](scrutiny_fa/) : Scrutiny WebUI for smartd S.M.A.R.T monitoring (Full Access) ( users)
...
&#10003; ![image](https://api.iconify.design/mdi/library.svg) [Seafile](seafile/) : High performance file syncing and sharing, with also Markdown WYSIWYG editing, Wiki, file label and other knowledge management features ( users)
...
&#10003;  [Sonarr NAS](sonarr/) : Can monitor multiple RSS feeds for new episodes of your favorite shows and will grab, sort and rename them ( users)
...
&#10003; ![image](https://api.iconify.design/mdi/chart-timeline.svg) [Spotweb](spotweb/) : Spotweb is a decentralized usenet community based on the Spotnet protocol ( users)
...
&#10003; ![image](https://api.iconify.design/mdi/silverware-fork-knife.svg) [Tandoor recipes](tandoor_recipes/) : recipe manager ( users)
...
&#10003; ![image](https://api.iconify.design/mdi/file-search.svg) [Tdarr](tdarr/) : Distributed transcode automation using FFmpeg/HandBrake ( users)
...
&#10003;  [Teamspeak server](teamspeak/) : voice communication for online gaming, education and training ( users)
...
&#10003; ![image](https://api.iconify.design/mdi/transmission-tower.svg) [Transmission](transmission/) : Bittorrent client based on linuxserver image ( users)
...
&#10003; ![image](https://api.iconify.design/mdi/transmission-tower.svg) [Transmission Openvpn](transmission_openvpn/) : Docker container running Transmission torrent client with WebUI over an OpenVPN tunnel (21 users)
...
&#10003;  [Ubooquity](ubooquity/) : Free, lightweight, and easy-to-use home server for your comics and ebooks (1 users)
...
&#10003; ![image](https://api.iconify.design/mdi/monitor.svg) [Webtop Alpine KDE](webtop_kde/) : Full linux desktop environment accessible via any modern web browser (48 users)
...
&#10003;  [Webtrees](webtrees/) : web's leading on-line collaborative genealogy application (6 users)
...
&#10003;  [Wger](wger/) : manage your personal workouts, weight and diet plans (7 users)
...
&#10003; ![image](https://api.iconify.design/mdi/magnify.svg) [Whoogle Search](whoogle/) : Self-hosted, ad-free, privacy-respecting metasearch engine (11 users)
...
&#10003;  [Xteve](xteve/) : M3U Proxy for Plex DVR and Emby Live TV (1 users)
...
&#10003;  [Zoneminder](zoneminder/) : A full-featured, open source, state-of-the-art video surveillance software system (16 users)
