...
&#10003;  [Papermerge](papermerge/) : Open source document management system (DMS) (58 users)
...
&#10003; ![image](https://api.iconify.design/mdi/camera.svg) [Photoprism](photoprism/) : A server-based application for browsing, organizing and sharing your personal photo collection (58 users)
...
&#10003;  [Piwigo](piwigo/) : Piwigo is a photo gallery software for the web (58 users)
...
&#10003;  [Plex NAS](plex/) : Plex organizes video, music and photos from personal media libraries and streams them to smart TVs, streaming boxes and mobile devices. (58 users)
...
&#10003;  [Plex meta manager](plex_meta_manager/) : Python script to update metadata information for movies, shows, and collections as well as automatically build collections (58 users)
...
&#10003; ![image](https://api.iconify.design/mdi/docker.svg) [Portainer](portainer/) : Manage your Docker environment with ease (58 users)
...
&#10003;  [Prowlarr NAS](prowlarr/) : Torrent Trackers and Usenet Indexers offering complete management ofSonarr, Radarr, Lidarr, and Readarr indexers with no per app setup required (58 users)
...
&#10003; ![image](https://api.iconify.design/mdi/progress-download.svg) [Qbittorrent](qbittorrent/) : qBittorrent is a bittorrent client (58 users)
...
&#10003;  [Radarr NAS](radarr/) : A fork of Sonarr to work with movies like Couchpotato (58 users)
...
&#10003;  [Readarr NAS](readarr/) : Book Manager and Automation (58 users)
...
&#10003;  [Repository Updater](addons_updater/) : Automatic addons update by aligning version tag with upstream releases (58 users)
...
&#10003;  [Requestrr](requestrr/) : Chatbot used to simplify using services like Sonarr/Radarr/Ombi via the use of chat (58 users)
...
&#10003; ![image](https://api.iconify.design/mdi/cloud-sync-outline.svg) [ResilioSync](resiliosync/) : Self-hosted file share and collaboration platform on the web (58 users)
...
&#10003; ![image](https://api.iconify.design/mdi/glasses.svg) [Scrutiny](scrutiny/) : Scrutiny WebUI for smartd S.M.A.R.T monitoring (58 users)
...
&#10003; ![image](https://api.iconify.design/mdi/glasses.svg) [Scrutiny (Full Access)](scrutiny_fa/) : Scrutiny WebUI for smartd S.M.A.R.T monitoring (Full Access) (58 users)
...
&#10003; ![image](https://api.iconify.design/mdi/library.svg) [Seafile](seafile/) : High performance file syncing and sharing, with also Markdown WYSIWYG editing, Wiki, file label and other knowledge management features (58 users)
...
&#10003;  [Sonarr NAS](sonarr/) : Can monitor multiple RSS feeds for new episodes of your favorite shows and will grab, sort and rename them (58 users)
...
&#10003; ![image](https://api.iconify.design/mdi/chart-timeline.svg) [Spotweb](spotweb/) : Spotweb is a decentralized usenet community based on the Spotnet protocol (58 users)
...
&#10003; ![image](https://api.iconify.design/mdi/silverware-fork-knife.svg) [Tandoor recipes](tandoor_recipes/) : recipe manager (58 users)
...
&#10003; ![image](https://api.iconify.design/mdi/file-search.svg) [Tdarr](tdarr/) : Distributed transcode automation using FFmpeg/HandBrake (58 users)
...
&#10003;  [Teamspeak server](teamspeak/) : voice communication for online gaming, education and training (58 users)
...
&#10003; ![image](https://api.iconify.design/mdi/transmission-tower.svg) [Transmission](transmission/) : Bittorrent client based on linuxserver image (58 users)
...
&#10003; ![image](https://api.iconify.design/mdi/transmission-tower.svg) [Transmission Openvpn](transmission_openvpn/) : Docker container running Transmission torrent client with WebUI over an OpenVPN tunnel (58 users)
...
&#10003;  [Ubooquity](ubooquity/) : Free, lightweight, and easy-to-use home server for your comics and ebooks (58 users)
...
&#10003;  [Unpackerr](unpackerr/) : Unpacks RARd files for Sonarr, Lidarr and Radarr (58 users)
...
&#10003;  [Vaultwarden (Bitwarden)](bitwarden/) : Open source password management solution (58 users)
...
&#10003; ![image](https://api.iconify.design/mdi/monitor.svg) [Webtop Alpine KDE](webtop_kde/) : Full linux desktop environment accessible via any modern web browser (58 users)
...
&#10003;  [Webtrees](webtrees/) : web's leading on-line collaborative genealogy application (58 users)
...
&#10003;  [Wger](wger/) : manage your personal workouts, weight and diet plans (33 users)
...
&#10003; ![image](https://api.iconify.design/mdi/magnify.svg) [Whoogle Search](whoogle/) : Self-hosted, ad-free, privacy-respecting metasearch engine (20 users)
