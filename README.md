...
1. Filebrowser (10227x)
2. Portainer (5414x)
3. Myelectricaldata (3749x)
...
&#10003; ![image](https://api.iconify.design/mdi/file-search.svg) [Filebrowser (10227x)](filebrowser/) : filebrowser provides a file managing interface within a specified directory and it can be used to upload, delete, preview, rename and edit your files
...
&#10003; ![image](https://api.iconify.design/mdi/docker.svg) [Portainer (5414x)](portainer/) : Manage your Docker environment with ease
...
&#10003;  [Portainer (5414x) Agent](portainer_agent/) : An agent used to manage all the resources in a Swarm cluster
