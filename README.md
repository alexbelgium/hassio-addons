...
&#10003; ![image](https://api.iconify.design/mdi/file-search.svg) [Filebrowser (5247x)](filebrowser/) : filebrowser provides a file managing interface within a specified directory and it can be used to upload, delete, preview, rename and edit your files
...
&#10003;  [Free Games Claimer (in development)](free_games_claimer/) : automatically claims free games on the Epic Games Store, Amazon Prime Gaming and GOG
...
&#10003; ![image](https://api.iconify.design/mdi/docker.svg) [Portainer (3665x)](portainer/) : Manage your Docker environment with ease
...
&#10003;  [Portainer (3665x) Agent](portainer_agent/) : An agent used to manage all the resources in a Swarm cluster
...
&#10003; ![image](https://api.iconify.design/mdi/progress-download.svg) [Qbittorrent (1049x)](qbittorrent/) : qBittorrent is a bittorrent client
