...
&#10003;  [Arpspoof](arpspoof/) : block internet connection for local network devices (498 users)
...
&#10003;  [Baikal](baikal/) : Baïkal is a Calendar+Contacts server (498 users)
...
&#10003;  [Bazarr NAS](bazarr/) : Companion application to Sonarr and Radarr to download subtitles (498 users)
...
&#10003;  [Booksonic-air](booksonic_air/) : platform for accessing the audibooks you own wherever you are (498 users)
...
&#10003;  [Browserless Chrome](browserless_chrome/) : Chrome as a service container (498 users)
...
&#10003; ![image](https://api.iconify.design/mdi/book-multiple.svg) [Calibre](calibre/) : e-book manager (498 users)
...
&#10003; ![image](https://api.iconify.design/mdi/library.svg) [Calibre-web](calibre_web/) : browsing, reading and downloading eBooks using an existing Calibre database (498 users)
...
&#10003; ![image](https://api.iconify.design/mdi/file-search.svg) [Cloudcommander](cloudcommander/) : Cloud Commander a file manager for the web with console and editor (462 users)
...
&#10003;  [Code-server (VScode)](code-server/) : Code-server is VS Code running on a remote server, accessible through the browser. (448 users)
...
&#10003;  [Elasticsearch server](elasticsearch/) : Free and Open, Distributed, RESTful Search Engine (436 users)
...
&#10003; ![image](https://api.iconify.design/mdi/emby.svg) [Emby NAS](emby/) : A Free Software Media System that puts you in control of managing and streaming your media. (424 users)
...
&#10003;  [Epic Games Free](epicgamesfree/) : Automatically login and redeem promotional free games from Epic Games Store (389 users)
...
&#10003; ![image](https://api.iconify.design/mdi/file-search.svg) [Filebrowser](filebrowser/) : filebrowser provides a file managing interface within a specified directory and it can be used to upload, delete, preview, rename and edit your files (389 users)
...
&#10003;  [Firefly iii](fireflyiii/) : A free and open source personal finance manager (389 users)
...
&#10003;  [Firefly iii Data Importer](fireflyiii_data_importer/) : Data importer for Firefly III (separate addon) (389 users)
...
&#10003;  [Firefly iii FinTS Importer](fireflyiii_fints_importer/) : Import financial transactions from your FinTS enabled bank into Firefly III (389 users)
...
&#10003;  [FlareSolverr](flaresolverr/) : Proxy server to bypass Cloudflare protection (389 users)
...
&#10003;  [Flexget](flexget/) : FlexGet is a multipurpose automation tool for all of your media (389 users)
...
&#10003;  [Gazpar2mqtt](gazpar2mqtt/) : fetch GRDF data and publish data to a mqtt broker (389 users)
...
&#10003;  [Gitea](gitea/) : Gitea for Home Assistant (389 users)
...
&#10003;  [Grav web server](grav/) : Fast, Simple, and Flexible, file-based Web-platform (389 users)
...
&#10003; ![image](https://api.iconify.design/mdi/lan.svg) [Guacamole Client](guacamole/) : Clientless remote desktop gateway (389 users)
...
&#10003;  [Inadyn](inadyn/) : Inadyn is a small and simple Dynamic DNS, DDNS, client with HTTPS support. A large number of dynamic dns providers are supported (https://github.com/troglobit/inadyn#supported-providers). For those that are not, you can use a custom provider as per this project's documentation (https://github.com/nalipaz/hassio-addons/blob/master/README.md) (389 users)
...
&#10003;  [Jackett NAS](jackett/) : translates queries from apps (Sonarr, SickRage, CouchPotato, Mylar, etc) into tracker-site-specific http queries, parses the html response, then sends results back to the requesting software (389 users)
...
&#10003; ![image](https://api.iconify.design/mdi/billiards-rack.svg) [Jellyfin NAS](jellyfin/) : A Free Software Media System that puts you in control of managing and streaming your media. (389 users)
...
&#10003; ![image](https://api.iconify.design/mdi/owl.svg) [Joal](joal/) : An open source command line RatioMaster with WebUI (389 users)
...
&#10003;  [Joplin Server](joplin/) : Self-hosted open source note-taking application (389 users)
...
&#10003;  [Lidarr NAS](lidarr/) : Music collection manager for Usenet and BitTorrent users (389 users)
...
&#10003; ![image](https://api.iconify.design/mdi/silverware-fork-knife.svg) [Mealie](mealie/) : Mealie is a self hosted recipe manager and meal planner built in Vue (389 users)
...
&#10003;  [MyElectricalData](enedisgateway2mqtt/) : use Enedis Gateway API to send data in your MQTT Broker (latest channel) (389 users)
...
&#10003;  [MyElectricalData Dev](enedisgateway2mqtt_dev/) : use Enedis Gateway API to send data in your MQTT Broker (dev channel) (389 users)
...
&#10003;  [Mylar3](mylar3/) : Automated comic book downloader for use with NZB and torrents (389 users)
...
&#10003; ![image](https://api.iconify.design/mdi/cloud.svg) [Nextcloud](nextcloud/) : Nextcloud for Home Assistant (389 users)
...
&#10003; ![image](https://api.iconify.design/mdi/arrow-down-bold-circle-outline.svg) [Nzbget](nzbget/) : usenet downloader (389 users)
...
&#10003;  [Omada](omada/) : TP-Link Omada Controller (389 users)
...
&#10003;  [Omada v3.2](omada_v3/) : TP-Link Omada Controller (389 users)
...
&#10003;  [Ombi](ombi/) : Self-hosted Plex Request and user management system (389 users)
...
&#10003;  [Organizr](organizr/) : An HTPC/Homelab services organizer that is written in PHP (389 users)
...
&#10003;  [Overseerr](overseerr/) : Request management and media discovery tool built to work with your existing Plex ecosystem (389 users)
...
&#10003;  [Paperless NGX](paperless_ngx/) : scan, index and archive all your physical documents (368 users)
...
&#10003;  [Papermerge](papermerge/) : Open source document management system (DMS) (206 users)
...
&#10003; ![image](https://api.iconify.design/mdi/camera.svg) [Photoprism](photoprism/) : A server-based application for browsing, organizing and sharing your personal photo collection (194 users)
...
&#10003;  [Piwigo](piwigo/) : Piwigo is a photo gallery software for the web (116 users)
...
&#10003;  [Plex NAS](plex/) : Plex organizes video, music and photos from personal media libraries and streams them to smart TVs, streaming boxes and mobile devices. (116 users)
...
&#10003;  [Plex meta manager](plex_meta_manager/) : Python script to update metadata information for movies, shows, and collections as well as automatically build collections (116 users)
...
&#10003; ![image](https://api.iconify.design/mdi/docker.svg) [Portainer](portainer/) : Manage your Docker environment with ease (116 users)
...
&#10003;  [Prowlarr NAS](prowlarr/) : Torrent Trackers and Usenet Indexers offering complete management ofSonarr, Radarr, Lidarr, and Readarr indexers with no per app setup required (116 users)
...
&#10003; ![image](https://api.iconify.design/mdi/progress-download.svg) [Qbittorrent](qbittorrent/) : qBittorrent is a bittorrent client (116 users)
...
&#10003;  [Radarr NAS](radarr/) : A fork of Sonarr to work with movies like Couchpotato (116 users)
...
&#10003;  [Readarr NAS](readarr/) : Book Manager and Automation (116 users)
...
&#10003;  [Repository Updater](addons_updater/) : Automatic addons update by aligning version tag with upstream releases (116 users)
...
&#10003;  [Requestrr](requestrr/) : Chatbot used to simplify using services like Sonarr/Radarr/Ombi via the use of chat (116 users)
...
&#10003; ![image](https://api.iconify.design/mdi/cloud-sync-outline.svg) [ResilioSync](resiliosync/) : Self-hosted file share and collaboration platform on the web (116 users)
...
&#10003; ![image](https://api.iconify.design/mdi/glasses.svg) [Scrutiny](scrutiny/) : Scrutiny WebUI for smartd S.M.A.R.T monitoring (116 users)
...
&#10003; ![image](https://api.iconify.design/mdi/glasses.svg) [Scrutiny (Full Access)](scrutiny_fa/) : Scrutiny WebUI for smartd S.M.A.R.T monitoring (Full Access) (116 users)
...
&#10003; ![image](https://api.iconify.design/mdi/library.svg) [Seafile](seafile/) : High performance file syncing and sharing, with also Markdown WYSIWYG editing, Wiki, file label and other knowledge management features (116 users)
...
&#10003;  [Sonarr NAS](sonarr/) : Can monitor multiple RSS feeds for new episodes of your favorite shows and will grab, sort and rename them (116 users)
...
&#10003; ![image](https://api.iconify.design/mdi/chart-timeline.svg) [Spotweb](spotweb/) : Spotweb is a decentralized usenet community based on the Spotnet protocol (116 users)
...
&#10003; ![image](https://api.iconify.design/mdi/silverware-fork-knife.svg) [Tandoor recipes](tandoor_recipes/) : recipe manager (116 users)
...
&#10003; ![image](https://api.iconify.design/mdi/file-search.svg) [Tdarr](tdarr/) : Distributed transcode automation using FFmpeg/HandBrake (116 users)
...
&#10003;  [Teamspeak server](teamspeak/) : voice communication for online gaming, education and training (116 users)
...
&#10003; ![image](https://api.iconify.design/mdi/transmission-tower.svg) [Transmission](transmission/) : Bittorrent client based on linuxserver image (116 users)
...
&#10003; ![image](https://api.iconify.design/mdi/transmission-tower.svg) [Transmission Openvpn](transmission_openvpn/) : Docker container running Transmission torrent client with WebUI over an OpenVPN tunnel (116 users)
...
&#10003;  [Ubooquity](ubooquity/) : Free, lightweight, and easy-to-use home server for your comics and ebooks (116 users)
...
&#10003;  [Unpackerr](unpackerr/) : Unpacks RARd files for Sonarr, Lidarr and Radarr (116 users)
...
&#10003;  [Vaultwarden (Bitwarden)](bitwarden/) : Open source password management solution (116 users)
...
&#10003; ![image](https://api.iconify.design/mdi/monitor.svg) [Webtop Alpine KDE](webtop_kde/) : Full linux desktop environment accessible via any modern web browser (116 users)
...
&#10003;  [Webtrees](webtrees/) : web's leading on-line collaborative genealogy application (116 users)
...
&#10003;  [Wger](wger/) : manage your personal workouts, weight and diet plans (116 users)
...
&#10003; ![image](https://api.iconify.design/mdi/magnify.svg) [Whoogle Search](whoogle/) : Self-hosted, ad-free, privacy-respecting metasearch engine (96 users)
...
&#10003;  [Xteve](xteve/) : M3U Proxy for Plex DVR and Emby Live TV (64 users)
...
&#10003;  [Zoneminder](zoneminder/) : A full-featured, open source, state-of-the-art video surveillance software system (60 users)
