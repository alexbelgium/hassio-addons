...
[![GitHub Super-Linter](https://github.com/alexbelgium/hassio-addons/workflows/Lint%20Code%20Base/badge.svg)](https://github.com/marketplace/actions/weekly-supelinter.yaml)
...
&#10003;  [Castsponsorskip](sponsorblockcast/) : skips sponsored YouTube content on all local Chromecasts
...
&#10003; ![image](https://api.iconify.design/mdi/file-search.svg) [Filebrowser (4034x)](filebrowser/) : filebrowser provides a file managing interface within a specified directory and it can be used to upload, delete, preview, rename and edit your files
...
&#10003; ![image](https://api.iconify.design/mdi/billiards-rack.svg) [Jellyfin (1712x) NAS](jellyfin/) : A Free Software Media System that puts you in control of managing and streaming your media
...
&#10003; ![image](https://api.iconify.design/mdi/docker.svg) [Portainer (3684x)](portainer/) : Manage your Docker environment with ease
...
&#10003;  [Portainer (3684x) Agent](portainer_agent/) : An agent used to manage all the resources in a Swarm cluster
