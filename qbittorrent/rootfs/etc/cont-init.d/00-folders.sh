...
# Move autoscript
if [ -f /homeassistant/addons_autoscripts/qbittorrent.sh ]; then
    cp -rnf /homeassistant/addons_autoscripts/qbittorrent.sh /config/ &> /dev/null || true
    mv /homeassistant/addons_autoscripts/qbittorrent.sh /homeassistant/addons_autoscripts/qbittorrent.sh.bak
