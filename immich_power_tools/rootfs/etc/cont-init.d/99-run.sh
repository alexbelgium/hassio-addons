...
export DB_HOST="$(extract_ip_or_domain "$DB_HOST")"
...
export IMMICH_URL="$(ensure_http_prefix "$IMMICH_URL")"
export EXTERNAL_IMMICH_URL="$(ensure_http_prefix "$EXTERNAL_IMMICH_URL")"
